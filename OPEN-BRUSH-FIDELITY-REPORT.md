...
- Position/frame smoothing, self-intersection width shrinking, discard, and
  adjacent-knot rebuild rules remain incomplete. Non-M11 `FlatGeometryBrush`
...
`three-icosa@d2f79a4`, and `three-tiltloader@1e1f096`. This establishes source
